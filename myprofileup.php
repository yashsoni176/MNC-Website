...
if(isset($_POST['update']))
{
 ...
 $result = mysqli_query($conn, "UPDATE `employee` SET `firstName`='$firstname',`lastName`='$lastname',`birthday`='$birthday',`gender`='$gender',`email`='$email',`contact`='$contact',`address`='$address' WHERE id=$id");
